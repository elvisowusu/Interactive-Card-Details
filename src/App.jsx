...
function App({name}) {
  ...
  return (
    <div className='relative font-SpaceGrotesk w-[35.5rem] md:w-full flex flex-col md:flex-row md:h-[110vh] xl:gap-[20rem] lg:gap-[14rem] md:gap-[13rem] md:items-center lg:bg-red-300 xl:bg-blue-400 md:bg-pink-300'>
      <div className={`${state.screenWidth >640?"bg-[url('./assets/bg-main-desktop.png')] bg-cover  h-[110vh] md:w-[21rem] lg:w-[30rem] xl:w-[35rem]":"bg-[url('./assets/bg-main-mobile.png')]"} bg-cover h-[23rem] w-[35.5rem]`}></div>

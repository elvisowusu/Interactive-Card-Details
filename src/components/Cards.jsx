...
export default function Cards({name,cardNumber,expDate,year, cvc}){
    return(
        <div className="absolute top-[3.3rem] left-[0.75rem]">
          <div className={`absolute top-[8.65rem] md:top-[8rem] left-0 md:left-[14.6rem] lg:left-[13rem]   sm:relative  bg-[url('./assets/bg-card-front.png')] h-[15.3rem] w-[27.97rem] rounded-lg flex flex-col justify-between p-[1.8rem] right-[2rem]`}>
          ...
          <div className={`flex justify-end items-center tracking-[0.14rem] text-White p-[3.8rem] bg-[url('./assets/bg-card-back.png')] h-[15.3rem] w-[27.97rem] rounded-lg ml-[6rem] md:ml-[21rem] md:mt-[10rem]`}>
